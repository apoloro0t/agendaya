...
export default function Home() {
  ...
  return (
    <>
      <style>{`
        :root{--bg:#FFF8F5;--bg-warm:#FFF1EC;--bg-card:#FFFFFF;--ink:#2D1B14;--ink-soft:#6B5147;--ink-mute:#A08E86;--coral:#FF4D6A;--coral-light:#FF6B84;--coral-deep:#E8375A;--coral-pale:#FFE4E9;--gold:#D4A853;--green:#2DB87A;--wa-green:#075E54;--wa-bg:#E5DDD5;--shadow-sm:0 1px 3px rgba(45,27,20,0.06);--shadow-md:0 4px 20px rgba(45,27,20,0.08);--radius:16px;--radius-sm:10px}
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        ...
        .wa-chat{padding:10px 10px 14px;min-height:180px;display:flex;flex-direction:column;gap:5px;background:var(--wa-bg)}
        .wa-date{align-self:center;background:rgba(225,218,210,0.9);padding:3px 10px;border-radius:6px;font-size:10px;color:#54656f;margin-bottom:4px}
      ...
      <nav><div className="wrap nav-inner"><a href="#" className="logo">Agenda<em>Ya</em></a><div className="nav-links"><a href="#funciona">Cómo funciona</a><a href="#planes">Planes</a><a href="/login">Iniciar sesión</a><a className="nav-cta" href="/registro">Empieza gratis</a></div></div></nav>

      <header className="hero">
        <div className="hero-blob hero-blob-1"></div>
        <div className="hero-blob hero-blob-2"></div>
        <div className="wrap">
          <div className="hero-badge">✨ Para salones de belleza</div>
          <h1>Agenda<em>Ya</em></h1>
          <p className="subtitle">Tu clienta agenda por WhatsApp.<br/>Tú solo atiendes.</p>
          <a className="hero-cta" href="/registro">Empieza gratis →</a>
          <p className="hero-note">Sin tarjeta · 14 días gratis</p>
          <div className="hero-visual"><div className="wa-phone"><div className="wa-screen">
            <div className="wa-statusbar"><span>10:24</span><div className="wa-statusbar-icons"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M1 9l2 2c4.97-4.97 13.03-4.97 18 0l2-2C16.93 2.93 7.08 2.93 1 9zm8 8l3 3 3-3a4.237 4.237 0 00-6 0zm-4-4l2 2a7.074 7.074 0 0110 0l2-2C15.14 9.14 8.87 9.14 5 13z"/></svg></div></div>
            <div className="wa-header"><div className="wa-back">‹</div><div className="wa-avatar">💇</div><div className="wa-contact"><div className="wa-contact-name">Salón Glamour ✨</div><div className="wa-contact-status">en línea</div></div></div>
            <div className="wa-chat">
              <div className="wa-date">HOY</div>
              <div className="wa-msg wa-msg-out">Hola, quiero agendar una cita 💅<div className="wa-msg-meta"><span className="wa-msg-time">10:23</span><span className="wa-ticks">✓✓</span></div></div>
              <div className="wa-msg wa-msg-in">¡Hola! 😊 Bienvenida a <b>Salón Glamour</b>. Soy Luna.<br/><br/>1️⃣ Corte — S/35<br/>2️⃣ Keratina — S/150<br/>3️⃣ Manicure — S/25<div className="wa-msg-meta"><span className="wa-msg-time">10:23</span></div></div>
              <div className="wa-msg wa-msg-in">✅ <b>¡Cita confirmada!</b><br/><br/>📋 Keratina · Mar 22 · 2pm<br/>📍 Salón Glamour, Ate 💕<div className="wa-msg-meta"><span className="wa-msg-time">10:25</span></div></div>
            </div>
            <div className="wa-inputbar"><span className="wa-emoji">😊</span><div className="wa-input-field">Escribe un mensaje</div><div className="wa-send"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg></div></div>
          </div></div></div>
        </div>
      </header>

      <section className="reveal"><div className="wrap sec-center">
        <div className="sec-label">¿Te suena familiar?</div>
        <div className="pains">
          <div className="pain"><div className="pain-num">01</div><p>Respondes WhatsApp mientras atiendes a tus clientas</p></div>
          <div className="pain"><div className="pain-num">02</div><p>Clientas que agendan y luego no llegan</p></div>
          <div className="pain"><div className="pain-num">03</div><p>Pierdes citas en la noche porque no puedes contestar</p></div>
          <div className="pain"><div className="pain-num">04</div><p>No sabes cuánto ganaste hasta fin de semana</p></div>
        </div>
      </div></section>

      <section className="steps-section reveal" id="funciona"><div className="wrap">
        <div className="sec-center"><div className="sec-label">Cómo funciona</div><div className="sec-title">3 pasos. Sin instalar nada.</div><p className="sec-sub">AgendaYa conecta tu WhatsApp con un bot inteligente que agenda por ti.</p></div>
        <div className="steps">
          <div className="step"><div className="step-num">01</div><h3>Tu clienta escribe</h3><p>Manda un WhatsApp y el bot responde al instante, 24/7.</p></div>
          <div className="step"><div className="step-num">02</div><h3>Elige su cita</h3><p>Selecciona servicio, fecha y hora en segundos.</p></div>
          <div className="step"><div className="step-num">03</div><h3>Tú recibes la cita</h3><p>Aparece en tu panel lista. Sin hacer nada.</p></div>
        </div>
      </div></section>

      <section className="testimonial-section reveal"><div className="wrap"><div className="testimonial">
        <div className="stars">★★★★★</div>
        <blockquote>"Antes perdía citas por no contestar a tiempo. Ahora mis clientas agendan solas."</blockquote>
        <cite><strong>María López</strong> · Salón Glamour, Ate - Lima</cite>
      </div></div></section>

      <section className="reveal" id="planes"><div className="wrap">
        <div className="sec-center"><div className="sec-label">Planes</div><div className="sec-title">Un plan para cada salón.</div><p className="sec-sub">Empieza gratis. Crece cuando tu negocio crece.</p></div>
        <div className="plans-grid">
          <div className="plan">
            <div className="plan-name">Free</div><div className="plan-price">S/0 <span className="per">/mes</span></div><div className="plan-desc">Para probar sin riesgo</div>
            <ul>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Hasta 15 citas al mes</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Bot de WhatsApp básico</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Panel de citas</li>
              <li className="no"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="ic-x"><path d="M18 6L6 18M6 6l12 12"/></svg>Sin recordatorios</li>
            </ul>
            <a className="plan-btn" href="/registro">Empezar gratis</a>
          </div>
          <div className="plan">
            <div className="plan-name">Básico</div><div className="plan-price">S/39 <span className="per">/mes</span></div><div className="plan-desc">Para el salón con clientela fija</div>
            <ul>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>50 citas al mes</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Recordatorios 24h antes</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Historial de clientas</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Bienvenida personalizada</li>
            </ul>
            <a className="plan-btn" href="/registro">Elegir Básico →</a>
          </div>
          <div className="plan popular"><div className="popular-tag">Popular</div>
            <div className="plan-name">Premium</div><div className="plan-price">S/69 <span className="per">/mes</span></div><div className="plan-desc">Para el salón que quiere crecer</div>
            <ul>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Citas ilimitadas</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Reportes semanales</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Reseñas post-cita</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Hasta 3 empleadas</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Soporte prioritario</li>
            </ul>
            <a className="plan-btn filled" href="/registro">Elegir Premium →</a>
          </div>
          <div className="plan">
            <div className="plan-name">Personalizado</div><div className="plan-price" style={{fontSize:'24px',lineHeight:'1.4'}}>A consultar</div><div className="plan-desc">Para negocios que necesitan más</div>
            <ul>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Todo del plan Premium</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Bot con IA</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Múltiples sucursales</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="ic-check"><path d="M20 6L9 17l-5-5"/></svg>Soporte dedicado 24/7</li>
            </ul>
            <a className="plan-btn" href="https://wa.me/51913276046?text=Hola%20quiero%20info%20del%20plan%20Personalizado">Consultar →</a>
          </div>
        </div>
      </div></section>

      <section className="reveal"><div className="wrap">
        <div className="sec-center"><div className="sec-label">Preguntas frecuentes</div><div className="sec-title">¿Tienes dudas?</div></div>
        <div className="faq-list">
          <div className="faq-item"><div className="faq-q">¿Necesito instalar algo?<svg className="faq-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M12 5v14M5 12h14"/></svg></div><div className="faq-a"><p>No. Funciona 100% desde WhatsApp y desde el navegador. Sin apps.</p></div></div>
          <div className="faq-item"><div className="faq-q">¿Funciona con mi número actual?<svg className="faq-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M12 5v14M5 12h14"/></svg></div><div className="faq-a"><p>Sí. Conectamos el bot a tu WhatsApp Business. Te ayudamos a configurarlo gratis.</p></div></div>
          <div className="faq-item"><div className="faq-q">¿Qué pasa si no pago?<svg className="faq-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M12 5v14M5 12h14"/></svg></div><div className="faq-a"><p>Pasas al plan Free. No pierdes tus datos ni tus clientas.</p></div></div>
          <div className="faq-item"><div className="faq-q">¿Puedo cancelar cuando quiera?<svg className="faq-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M12 5v14M5 12h14"/></svg></div><div className="faq-a"><p>Sí, sin penalidad. Sin contratos, sin letra chica.</p></div></div>
        </div>
      </div></section>

      <section className="reveal"><div className="wrap"><div className="final-cta">
        <h2>Deja de anotar citas en el cuaderno.</h2>
        <p>Tu primera clienta puede agendar sola hoy mismo.</p>
        <a className="wa-btn" href="https://wa.me/51913276046?text=Hola%20quiero%20probar%20AgendaYa" target="_blank" rel="noopener">
      ...
      <footer><div className="wrap">
        <p className="footer-main">© 2026 AgendaYa · Hecho en Perú 🇵🇪</p>
        <div className="footer-legal">
          <a href="#" onClick={(e)=>{e.preventDefault();(document.getElementById('modal-terms') as any)?.classList.add('active')}}>Términos y Condiciones</a>
          <a href="#" onClick={(e)=>{e.preventDefault();(document.getElementById('modal-privacy') as any)?.classList.add('active')}}>Política de Privacidad</a>
        </div>
      </div></footer>

      <div className="modal-overlay" id="modal-terms"><div className="modal-box">
        <button className="modal-close" onClick={()=>(document.getElementById('modal-terms') as any)?.classList.remove('active')}>✕</button>
        <h2>Términos y Condiciones</h2>
        <p><em>Última actualización: abril 2026</em></p>
        <h3>1. Aceptación</h3><p>Al usar AgendaYa aceptas estos términos.</p>
        <h3>2. Descripción del servicio</h3><p>AgendaYa es un sistema de agenda automática por WhatsApp para negocios de servicios.</p>
        <h3>3. Planes y pagos</h3><p>Los precios están en soles peruanos. Los pagos son mensuales y se renuevan automáticamente. Puedes cancelar sin penalidad.</p>
        <h3>4. Uso aceptable</h3><p>No puedes usar AgendaYa para spam o actividades ilegales.</p>
        <h3>5. Contacto</h3><p>Para consultas, escríbenos por WhatsApp.</p>
      </div></div>

      <div className="modal-overlay" id="modal-privacy"><div className="modal-box">
        <button className="modal-close" onClick={()=>(document.getElementById('modal-privacy') as any)?.classList.remove('active')}>✕</button>
        <h2>Política de Privacidad</h2>
        <p><em>Última actualización: abril 2026</em></p>
        <h3>1. Datos que recopilamos</h3><p>Nombre del negocio, WhatsApp y datos de citas agendadas.</p>
        <h3>2. Uso de los datos</h3><p>Solo para operar el servicio de agenda.</p>
        <h3>3. Compartir datos</h3><p>No vendemos ni compartimos tus datos con terceros.</p>
        <h3>4. Tus derechos</h3><p>Puedes solicitar la eliminación de tus datos en cualquier momento.</p>
      </div></div>
    </>
  )
}